...
export interface CapaContainmentRiskAdvisoryGenerator { generate(input: { readonly context: CapaContainmentRiskAdvisoryContextAssembly; readonly focus: string | null; readonly request_id: RequestId; readonly correlation_id: CorrelationId }): Promise<{ readonly advisory: RawCapaContainmentRiskAdvisoryModelOutput; readonly trace: unknown }>; }
