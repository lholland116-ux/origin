...
export function buildCapaInvestigationPlanningAdvisoryPrompt(input: {
  ...
  return [
    ...
    "Question grammar is mandatory for every human_review_question and verification_question: write one atomic single-clause question that ends with exactly one question mark, and the question mark appears only at the end. The first word must be one of: Does, Do, Is, Are, May, Can, Could, Should, Must, What, Which, Who, How, When, Where, Whether.",
