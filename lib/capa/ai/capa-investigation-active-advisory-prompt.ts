...
export function buildCapaInvestigationActiveAdvisoryPrompt(input: {
  ...
  return [
    ...
    "For every human_review_question and verification_question, write exactly one concise direct question. Begin with exactly one of: does, do, did, is, are, was, were, may, might, can, could, should, would, must, what, which, who, whom, whose, why, how, when, where, whether. End with exactly one terminal ?. Do not use an internal ?, comma, colon, semicolon, period, newline, dash-separated explanation, assertion suffix, or a second independent question joined with and. Shorten the wording when needed to comply.",
