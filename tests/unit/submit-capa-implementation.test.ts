...
describe("controlled S80 implementation submission", () => {
  ...
  it("materializes the human-owned package, transitions to S90, and preserves lineage", async () => {
    ...
    expect(h.materializedSection).toMatchObject({ section_type: CAPA_IMPLEMENTATION_REVIEW_BASELINE_SECTION_TYPE, schema_version: CAPA_IMPLEMENTATION_REVIEW_BASELINE_SCHEMA_VERSION, created_by: { actor_type: "human", actor_id: USER } });
